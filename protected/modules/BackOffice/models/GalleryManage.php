 ...
 */
class GalleryManage extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			'gallery_id' => 'ID',
			'gallery_capt_th' => 'Caption (Thai)',
			'gallery_capt_en' => 'Caption (English)',
			'gallery_image' => 'Image',
			'gallery_update_date' => 'Last Update',
		);
	}
	 ...
	 * @return GalleryManage the static model class
	 */
