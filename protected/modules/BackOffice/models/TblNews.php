 ...
 * @property string $news_title_th
 * @property string $news_title_en
 * @property string $news_content_th
...
class TblNews extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('news_title_th, news_title_en, news_content_th, news_content_en, news_update_date, news_creator', 'required'),
            array('news_title_th, news_title_en, news_picture', 'length', 'max' => 250),
            array('news_status', 'length', 'max' => 8),
            array('news_creator', 'length', 'max' => 10),
            array('news_create_date, news_expire_date', 'safe'),
            array('news_picture', 'file', 'types' => 'jpg, jpeg, png, gif'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            //array('news_id, news_title_th, news_title_en, news_content_th, news_content_en, news_picture, news_create_date, news_expire_date, news_update_date, news_status, news_creator', 'safe', 'on' => 'search'),
            array('news_title_th, news_title_en, news_content_th, news_content_en, news_picture, news_create_date, news_expire_date, news_update_date, news_status, news_creator', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            'news_id' => 'ID',
            'news_title_th' => 'Title (Thai)',
            'news_title_en' => 'Title (English)',
            'news_content_th' => 'Content (Thai)',
            'news_content_en' => 'Content (English)',
            'news_picture' => 'Image',
            'news_create_date' => 'Created Date',
            'news_expire_date' => 'Expired Date',
            'news_update_date' => 'Last Updated',
            'news_status' => 'Status',
...
//        $criteria->compare('news_id', $this->news_id, true);
        $criteria->compare('news_title_th', $this->news_title_th, true);
        $criteria->compare('news_title_en', $this->news_title_en, true);
        $criteria->compare('news_content_th', $this->news_content_th, true);
