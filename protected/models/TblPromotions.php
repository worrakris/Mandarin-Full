...
class TblPromotions extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('promotion_id, promotion_title_th, promotion_title_en, promotion_content_th, promotion_content_en, promotion_picture, promotion_create_date, promotion_start_date, promotion_expire_date, promotion_update_date, promotion_status, promotion_creator', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'promotion_title_th' => 'Promotion Title Th',
			'promotion_title_en' => 'Promotion Title En',
			'promotion_content_th' => 'Promotion Content Th',
